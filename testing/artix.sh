...
echo "//192.168.1.236/qwertyuiop /home/marroq/qwertyuiop-server cifs username=marroq,password=HateSuburbia2022!,iocharset=utf8,file_mode=0777,dir_mode=0777" >> /mnt/etc/fstab
