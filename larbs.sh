...
progsfile="https://raw.githubusercontent.com/elwolf6/LARBS-legacy/master/progs.csv"
aurhelper="yay"
repobranch="master"
export TERM=ansi
...
installffaddons(){
	addonlist="ublock-origin decentraleyes istilldontcareaboutcookies 0t-reverse tampermonkey nord-polar-night-theme tree-style-tab dont-accept-webp jkcs dont-accept-webp"
	addontmp="$(mktemp -d)"
