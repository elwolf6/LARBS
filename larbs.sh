...
installffaddons(){
	addonlist="ublock-origin decentraleyes istilldontcareaboutcookies 0t-reverse tampermonkey darkreader nord-polar-night-theme tree-style-tab dont-accept-webp"
	addontmp="$(mktemp -d)"
